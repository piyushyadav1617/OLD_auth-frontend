  ...
  return (
    <div className="flex h-screen w-screen">
      <div className="flex flex-col justify-center items-center w-3/5">
        ...
        <form className="flex flex-col w-full items-center text-left">
  <input type="text" id="email" className="px-4 py-2 w-3/4 md:w-1/2 lg:w-1/2" placeholder="name@example.com" />
